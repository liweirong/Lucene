...
public class AuditRecordLuceneNew {
    ...
    private String destIp;    //LongField 服务端IP
    ...
    private String sessionId;//  LongField 会话id
    ...
    private Integer tableNum;//TextField 表数量
    ...
    private Integer sqlResponse;//String 语句执行回应
