...
//
//public class LuceneIndexB {
//    private static final Logger log = Logger.getLogger(LuceneIndexB.class);
//    // 索引路径
...
//     * @return 总数
//     */
//    private static int insert(List<AuditRecordWithBLOBs> list, IndexWriter indexWriter) {
//        int total = 0;
